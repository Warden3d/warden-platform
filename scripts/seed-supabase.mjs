...
const data = {
  ...
  drops: [
    { id: "drop-001", slug: "city-sector-command-complex", name: "City Sector — Command Complex", description: "A modular urban sector designed for tactical engagements.", theme: "City Terrain", starts_at: "2026-07-20T17:00:00Z", ends_at: "2026-12-31T23:59:59Z", status: "live", thumbnail_url: "/images/drops/steel-edition.svg", price: 89.99 /* DEMO PRICE (R053D) — sustituir por precio comercial real antes del lanzamiento público definitivo. No usar en otro Drop. */ },
