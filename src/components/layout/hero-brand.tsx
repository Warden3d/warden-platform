...
export function HeroBrand() {
  ...
  return (
    <div className="flex flex-col items-center justify-start pt-[20vh] min-h-[80vh] px-6 text-center">
      <Image
        ...
        priority
      />
      <p className="mt-16 text-base font-bold tracking-[0.35em] uppercase text-foreground md:text-lg lg:text-2xl">
        {t("heroSlogan")}
      </p>
      <div className="mt-16">
